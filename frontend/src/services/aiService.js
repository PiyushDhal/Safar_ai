/**
 * VibeVoyage AI service — frontend entry point.
 *
...
if (import.meta.env.DEV) {
  console.info(
    '[VibeVoyage AI] Configuration status:',
...
export async function generateAITravelResponse(message, options = {}) {
  ...
  if (apiUrl) {
    try {
      ...
      console.warn('[VibeVoyage AI] Railway API server call failed, falling back to local client:', error);
    }
  }
