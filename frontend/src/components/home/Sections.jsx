  ...
  return (
    <section aria-labelledby="how-heading" className="space-y-8">
      <SectionHeader
        ...
        description="No spreadsheets, no twenty open tabs. Yatri AI keeps the whole trip in one place."
      />
  ...
  return (
    <section aria-labelledby="reviews-heading" className="space-y-8">
      <SectionHeader
        ...
        description="Real plans, real budgets — feedback from the Yatri AI community."
      />
