    ...
    <footer className="relative mt-24 overflow-hidden border-t border-line bg-surface">
      ...
      <div className="content-grid relative py-14">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr] lg:items-center">
            <div>
              ...
              <p className="mt-3 max-w-lg text-sm leading-6 text-white/80">
                Tell Yatri AI where and when. We handle the itinerary, budget, stays, transport and safety notes.
              </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-line pt-6 sm:flex-row">
          <p className="text-xs text-fg-subtle">© {new Date().getFullYear()} Yatri AI · A TravelCore Product</p>
