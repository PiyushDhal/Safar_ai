...
/**
 * BrandLogo — Official Safar AI Brand Logo.
 * Renders the glowing Safar AI globe flight mark alongside full Safar AI typography
 * and the official "AI-POWERED TRAVEL INTELLIGENCE" tagline.
 */
      ...
      {!compact && (
        <span className="flex flex-col justify-center leading-none">
          <span className="flex items-center text-xl font-black tracking-tight">
            ...
            <span className="bg-gradient-to-r from-cyan-400 via-sky-400 to-blue-500 bg-clip-text text-transparent font-black drop-shadow-[0_0_12px_rgba(6,182,212,0.4)] ml-1">
              AI
            </span>
          </span>
          <span
