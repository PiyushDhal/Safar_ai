...
function NearbyExplorer() {
  usePageMeta(
    'Nearby Places Explorer | Yatri AI',
    'Discover nearby attractions, restaurants, hotels, and cafes in your destination with Yatri AI.'
  );
    ...
    <div className="space-y-8">
      ...
      {!loading && !hasSearch && (
        <EmptyState
          ...
          description="Pick one of the covered cities above, or let Yatri AI detect the closest one to you."
