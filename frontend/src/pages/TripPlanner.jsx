...
function TripPlanner() {
  usePageMeta('Trip Planner | Safar AI', 'Generate AI-powered multi-day travel itineraries with Safar AI.');
  ...
  const planAsText = () =>
    [
      `Safar AI — ${days}-day ${style} trip to ${destination.trim()}`,
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Pick a destination, set your dates and travel style. Safar AI drafts a realistic day-by-day plan you can save, refine or export."
        actions={
          <>
