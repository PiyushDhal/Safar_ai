      ...
      <div className="relative grid gap-8 lg:grid-cols-[1.1fr_1fr] lg:items-center">
        <div>
          ...
          <p className="mt-3 max-w-lg text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            Safar AI knows your saved trips, preferred style and recently viewed destinations — so answers arrive already tailored to the exact way you travel.
          </p>
...
function HomePage() {
  usePageMeta(
    'Safar AI | Cinematic AI Travel Intelligence Platform',
    'Safar AI helps travelers plan smarter and safer with AI itinerary generation, 3D destination intelligence, transport tools, and personalized recommendations.'
  );
